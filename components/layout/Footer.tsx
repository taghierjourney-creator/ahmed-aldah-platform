  ...
  return (
    <footer className="bg-[#0F172A] px-4 py-12 text-slate-300 sm:px-6 lg:px-8" role="contentinfo">
      <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-4">
        ...
        <div><h3 className="font-semibold text-white">التنقل</h3><div className="mt-3 space-y-2 text-sm"><Link className="block hover:text-[#E2B857]" href="/ar">الرئيسية</Link><Link className="block hover:text-[#E2B857]" href="/ar/blog">المقالات</Link><Link className="block hover:text-[#E2B857]" href="/ar/research">الأبحاث</Link><Link className="block hover:text-[#E2B857]" href="/ar/books">الكتب</Link></div></div>
